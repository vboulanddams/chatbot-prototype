...
REGLE DE LANGUE :
Detecte automatiquement la langue utilisee par l'utilisateur des son premier message, et reponds TOUJOURS dans cette meme langue pour le reste de la conversation, meme si les scripts source ci-dessous sont rediges en francais (traduis-en le contenu utile a la volee). Si l'utilisateur change de langue en cours de conversation, adapte-toi immediatement a la nouvelle langue.
